...
#define cmpxchg_cputime(ptr, old, new) cmpxchg(ptr, old, new)
	...
	(PPM_RHEL_RELEASE_CODE > 0 &&                                          \
	 PPM_RHEL_RELEASE_CODE >= PPM_RHEL_RELEASE_VERSION(7, 7))
...
static void fetch_task_cputime(struct task_struct *t, cputime_t *u_dst,
			       cputime_t *s_dst, cputime_t *u_src,
			       cputime_t *s_src, cputime_t *udelta,
			       cputime_t *sdelta)
{
    unsigned int seq;
...
static inline void task_cputime(struct task_struct *t, cputime_t *utime,
				cputime_t *stime)
{
    if(utime)
	*utime = t->utime;
...
#endif /* (defined CONFIG_VIRT_CPU_ACCOUNTING_NATIVE) || (LINUX_VERSION_CODE < \
