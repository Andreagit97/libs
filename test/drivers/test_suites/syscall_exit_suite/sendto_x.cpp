...
TEST(SyscallExit, sendtoX_ipv4_tcp_message_not_truncated_by_snaplen)
{
	...
	evt_test->assert_bytebuf_param(2, MESSAGE_SHORTER_THAN_SNAPLEN, MESSAGE_SHORTER_THAN_SNAPLEN_LEN);
...
TEST(SyscallExit, sendtoX_ipv4_tcp_message_truncated_by_snaplen)
{
	...
	/* Parameter 2: data (type: PT_BYTEBUF)*/
	evt_test->assert_bytebuf_param(2, MESSAGE_LONGER_THAN_SNAPLEN, DEFAULT_SNAPLEN);
...
TEST(SyscallExit, sendtoX_ipv4_tcp_message_not_truncated_fullcapture_port)
{
	...
	/* Parameter 2: data (type: PT_BYTEBUF)*/
	evt_test->assert_bytebuf_param(2, MESSAGE_LONGER_THAN_SNAPLEN, MESSAGE_LONGER_THAN_SNAPLEN_LEN);
