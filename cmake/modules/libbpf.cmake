...
elseif(NOT USE_BUNDLED_LIBBPF)
    ...
    ExternalProject_Add(
        ...
        BUILD_COMMAND BUILD_STATIC_ONLY=y OBJDIR=${LIBBPF_BUILD_DIR}/build DESTDIR=${LIBBPF_BUILD_DIR}/root EXTRA_CFLAGS=${LIBELF_INCLUDE} make -C ${LIBBPF_SRC}/libbpf/src install V=1
        INSTALL_COMMAND ""
        UPDATE_COMMAND ""
    )
