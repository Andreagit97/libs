...
class SINSP_PUBLIC sinsp_chisel
{
    ...
    string get_name() { return m_filename; }
    uint32_t get_n_args();
    ...
    chisel_desc* get_lua_script_info() { return &m_lua_script_info; }
    ...
    static void parse_view_column(lua_State* ls, OUT chisel_desc* cd,
				  OUT void* columns);
    static void parse_view_columns(lua_State* ls, OUT chisel_desc* cd,
				   OUT void* columns);
    static void parse_view_action(lua_State* ls, OUT chisel_desc* cd,
				  OUT void* actions);
    static void parse_view_actions(lua_State* ls, OUT chisel_desc* cd,
				   OUT void* actions);
