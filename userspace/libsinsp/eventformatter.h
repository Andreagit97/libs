...
class SINSP_PUBLIC sinsp_evt_formatter : public gen_event_formatter
{
    ...
    */
    ...
    void set_format(gen_event_formatter::output_format of,
		    const string &fmt) override;
    ...
    */
    ...
    bool get_field_values(gen_event *evt,
    ...
    */
    ...
    bool tostring_withformat(gen_event *evt, std::string &output,
			     gen_event_formatter::output_format of) override;
...
class SINSP_PUBLIC sinsp_evt_formatter_cache
{
    ...
    bool resolve_tokens(sinsp_evt *evt, std::string &format,
    ...
    std::map<std::string, std::shared_ptr<sinsp_evt_formatter>>
	    m_formatter_cache;
    sinsp *m_inspector;
};
/*@}*/
...
class sinsp_evt_formatter_factory : public gen_event_formatter_factory
{
    ...
    create_formatter(const std::string &format) override;
