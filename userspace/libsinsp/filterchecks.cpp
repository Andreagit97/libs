...
const filtercheck_field_info sinsp_filter_check_fd_fields[] = {
	{PT_INT64, EPF_NONE, PF_ID, "fd.num", "FD Number",
	 "the unique number identifying the file descriptor."},
	{PT_CHARBUF, EPF_NONE, PF_DEC, "fd.type", "FD Type",
	 "type of FD. Can be 'file', 'directory', 'ipv4', 'ipv6', 'unix', "
	 "'pipe', 'event', 'signalfd', 'eventpoll', 'inotify' or 'signalfd'."},
	{PT_CHARBUF, EPF_NONE, PF_DEC, "fd.typechar", "FD Type Char",
	 "type of FD as a single character. Can be 'f' for file, 4 for IPv4 "
	 "socket, 6 for IPv6 socket, 'u' for unix socket, p for pipe, 'e' for "
	 "eventfd, 's' for signalfd, 'l' for eventpoll, 'i' for inotify, 'o' "
	 "for unknown."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.name", "FD Name",
	 ...
	 "tuple."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.directory", "FD Directory",
	 "If the fd is a file, the directory that contains it."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.filename", "FD Filename",
	 "If the fd is a file, the filename without the path."},
	{PT_IPADDR, EPF_FILTER_ONLY, PF_NA, "fd.ip", "FD IP Address",
	 "matches the ip address (client or server) of the fd."},
	{PT_IPADDR, EPF_NONE, PF_NA, "fd.cip", "FD Client Address",
	 "client IP address."},
	{PT_IPADDR, EPF_NONE, PF_NA, "fd.sip", "FD Server Address",
	 "server IP address."},
	{PT_IPADDR, EPF_NONE, PF_NA, "fd.lip", "FD Local Address",
	 "local IP address."},
	{PT_IPADDR, EPF_NONE, PF_NA, "fd.rip", "FD Remote Address",
	 "remote IP address."},
	{PT_PORT, EPF_FILTER_ONLY, PF_DEC, "fd.port", "FD Port",
	 "matches the port (either client or server) of the fd."},
	{PT_PORT, EPF_NONE, PF_DEC, "fd.cport", "FD Client Port",
	 "for TCP/UDP FDs, the client port."},
	{PT_PORT, EPF_NONE, PF_DEC, "fd.sport", "FD Server Port",
	 "for TCP/UDP FDs, server port."},
	{PT_PORT, EPF_NONE, PF_DEC, "fd.lport", "FD Local Port",
	 "for TCP/UDP FDs, the local port."},
	{PT_PORT, EPF_NONE, PF_DEC, "fd.rport", "FD Remote Port",
	 "for TCP/UDP FDs, the remote port."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.l4proto", "FD IP Protocol",
	 "the IP protocol of a socket. Can be 'tcp', 'udp', 'icmp' or 'raw'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.sockfamily", "FD Socket Family",
	 "the socket family for socket events. Can be 'ip' or 'unix'."},
	{PT_BOOL, EPF_NONE, PF_NA, "fd.is_server", "FD Server",
	 "'true' if the process owning this FD is the server endpoint in the "
	 "connection."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.uid", "FD ID",
	 "a unique identifier for the FD, created by chaining the FD number "
	 "and the thread ID."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.containername", "FD Container Name",
	 "chaining of the container ID and the FD name. Useful when trying to "
	 "identify which container an FD belongs to."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.containerdirectory",
	 "FD Container Directory",
	 "chaining of the container ID and the directory name. Useful when "
	 "trying to identify which container a directory belongs to."},
	{PT_PORT, EPF_FILTER_ONLY, PF_NA, "fd.proto", "FD Protocol",
	 "matches the protocol (either client or server) of the fd."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.cproto", "FD Client Protocol",
	 "for TCP/UDP FDs, the client protocol."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.sproto", "FD Server Protocol",
	 "for TCP/UDP FDs, server protocol."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.lproto", "FD Local Protocol",
	 "for TCP/UDP FDs, the local protocol."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.rproto", "FD Remote Protocol",
	 "for TCP/UDP FDs, the remote protocol."},
	{PT_IPNET, EPF_FILTER_ONLY, PF_NA, "fd.net", "FD IP Network",
	 "matches the IP network (client or server) of the fd."},
	{PT_IPNET, EPF_FILTER_ONLY, PF_NA, "fd.cnet", "FD Client Network",
	 "matches the client IP network of the fd."},
	{PT_IPNET, EPF_FILTER_ONLY, PF_NA, "fd.snet", "FD Server Network",
	 "matches the server IP network of the fd."},
	{PT_IPNET, EPF_FILTER_ONLY, PF_NA, "fd.lnet", "FD Local Network",
	 "matches the local IP network of the fd."},
	{PT_IPNET, EPF_FILTER_ONLY, PF_NA, "fd.rnet", "FD Remote Network",
	 "matches the remote IP network of the fd."},
	{PT_BOOL, EPF_NONE, PF_NA, "fd.connected", "FD Connected",
	 "for TCP/UDP FDs, 'true' if the socket is connected."},
	{PT_BOOL, EPF_NONE, PF_NA, "fd.name_changed", "FD Name Changed",
	 "True when an event changes the name of an fd used by this event. "
	 "This can occur in some cases such as udp connections where the "
	 "connection tuple changes."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.cip.name", "FD Client Domain Name",
	 "Domain name associated with the client IP address."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.sip.name", "FD Server Domain Name",
	 "Domain name associated with the server IP address."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.lip.name", "FD Local Domain Name",
	 "Domain name associated with the local IP address."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fd.rip.name", "FD Remote Domain Name",
	 "Domain name associated with the remote IP address."},
	{PT_INT32, EPF_NONE, PF_HEX, "fd.dev", "FD Device",
	 "device number (major/minor) containing the referenced file"},
	{PT_INT32, EPF_NONE, PF_DEC, "fd.dev.major", "FD Major Device",
	 "major device number containing the referenced file"},
	{PT_INT32, EPF_NONE, PF_DEC, "fd.dev.minor", "FD Minor Device",
	 "minor device number containing the referenced file"},
	{PT_INT64, EPF_NONE, PF_DEC, "fd.ino", "FD Inode Number",
...
sinsp_filter_check_fd::sinsp_filter_check_fd()
{
    ...
    m_info.m_name = "fd";
    m_info.m_desc =
	    "Every syscall that has a file descriptor in its arguments has "
	    "these fields set with information related to the file.";
    m_info.m_fields = sinsp_filter_check_fd_fields;
    m_info.m_nfields = sizeof(sinsp_filter_check_fd_fields) /
		       sizeof(sinsp_filter_check_fd_fields[0]);
							...
							bool sanitize_strings)
{
    ...
    {
	const char* argstr = evt->get_param_as_str(
		1, &resolved_argstr, m_inspector->get_buffer_format());
	...
	{
	    //
	    // XXX This is highly inefficient, as it re-requests the enter event
	    // and then does unnecessary allocations and copies. We assume that
	    // failed openat() happen rarely enough that we don't care.
	    //
	    if(!m_inspector->get_parser()->retrieve_enter_event(&enter_evt,
								evt))
	    {
		return false;
	    }
	...
	parinfo = etype == PPME_SYSCALL_OPENAT_X ? enter_evt.get_param(1)
						 : evt->get_param(2);
	name = parinfo->m_val;
	namelen = parinfo->m_len;

	parinfo = etype == PPME_SYSCALL_OPENAT_X ? enter_evt.get_param(0)
						 : evt->get_param(1);
	...
	sinsp_utils::concatenate_paths(fullpath, SCAP_MAX_PATH_SIZE,
				       sdir.c_str(), (uint32_t)sdir.length(),
				       name, namelen,
						     ...
						     bool sanitize_strings)
{
    *len = 0;
    //
    // Even is there's no fd, we still try to extract a name from exit events
    // that create one. With these events, the fact that there's no FD means
    // that the call failed, but even if that happened we still want to collect
    // the name.
    //
    switch(m_field_id)
    {
    ...
    case TYPE_FILENAME:
    {
	if(evt->get_type() != PPME_SYSCALL_OPEN_E &&
	   evt->get_type() != PPME_SYSCALL_OPENAT_E &&
	   evt->get_type() != PPME_SYSCALL_OPENAT_2_E &&
	   evt->get_type() != PPME_SYSCALL_OPENAT2_E &&
	...
	*len = 1;
	...
	if(evt_type == SCAP_FD_IPV4_SOCK)
	{
	    m_tstr = sinsp_dns_manager::get().name_of(
		    AF_INET, &m_fdinfo->m_sockinfo.m_ipv4info.m_fields.m_sip,
		    evt->get_ts());
	}
	else if(evt_type == SCAP_FD_IPV6_SOCK)
	{
	...
	{
	    m_tstr = sinsp_dns_manager::get().name_of(
		    AF_INET, &m_fdinfo->m_sockinfo.m_ipv4info.m_fields.m_dip,
		    evt->get_ts());
	}
	else if(evt_type == SCAP_FD_IPV4_SERVSOCK)
	{
	    m_tstr = sinsp_dns_manager::get().name_of(
		    AF_INET, &m_fdinfo->m_sockinfo.m_ipv4serverinfo.m_ip,
		    evt->get_ts());
	}
	else if(evt_type == SCAP_FD_IPV6_SOCK)
	{
	...
	if(evt_type == SCAP_FD_IPV4_SOCK)
	{
	    is_local = m_inspector->get_ifaddr_list()
			       ->is_ipv4addr_in_local_machine(
				       m_fdinfo->m_sockinfo.m_ipv4info.m_fields
					       .m_sip,
				       m_tinfo);
	}
	else
	{
	    is_local = m_inspector->get_ifaddr_list()
			       ->is_ipv6addr_in_local_machine(
				       m_fdinfo->m_sockinfo.m_ipv6info.m_fields
					       .m_sip,
				       m_tinfo);
	}
	...
	{
	    RETURN_EXTRACT_VAR(
		    m_fdinfo->m_sockinfo.m_ipv4info.m_fields.m_sport);
	}
	else if(evt_type == SCAP_FD_IPV6_SOCK)
	{
	    RETURN_EXTRACT_VAR(
		    m_fdinfo->m_sockinfo.m_ipv6info.m_fields.m_sport);
	}
    }
	...
	if(evt_type == SCAP_FD_IPV4_SOCK)
	{
	    ...
	    RETURN_EXTRACT_VAR(
		    m_fdinfo->m_sockinfo.m_ipv4info.m_fields.m_dport);
	}
	else if(evt_type == SCAP_FD_IPV4_SERVSOCK)
	{
	...
	else if(evt_type == SCAP_FD_IPV6_SOCK)
	{
	    ...
	    RETURN_EXTRACT_VAR(
		    m_fdinfo->m_sockinfo.m_ipv6info.m_fields.m_dport);
	}
	else if(evt_type == SCAP_FD_IPV6_SERVSOCK)
	{
	...
	{
	    m_tstr = port_to_string(
		    nport, this->m_fdinfo->get_l4proto(),
		    m_inspector->m_hostname_and_port_resolution_enabled);
	}
	else if(evt_type == SCAP_FD_IPV6_SOCK)
	{
	...
	if(m_fdinfo->m_type == SCAP_FD_IPV4_SERVSOCK ||
	   m_fdinfo->m_type == SCAP_FD_IPV6_SERVSOCK)
	{
	    m_tbool = true;
	}
	else if(m_fdinfo->m_type == SCAP_FD_IPV4_SOCK)
	{
	    m_tbool = m_inspector->get_ifaddr_list()
			      ->is_ipv4addr_in_local_machine(
				      m_fdinfo->m_sockinfo.m_ipv4info.m_fields
					      .m_dip,
				      m_tinfo);
	...
	if(m_fdinfo->m_type == SCAP_FD_IPV4_SOCK ||
	   ...
	   m_fdinfo->m_type == SCAP_FD_IPV4_SERVSOCK ||
	   m_fdinfo->m_type == SCAP_FD_IPV6_SERVSOCK)
	{
	    m_tstr = "ip";
	    RETURN_EXTRACT_STRING(m_tstr);
...
bool sinsp_filter_check_fd::compare_ip(sinsp_evt* evt)
{
	...
	if(evt_type == SCAP_FD_IPV4_SOCK)
	{
		...
		if(flt_compare(
			   m_cmpop, PT_IPV4ADDR,
			   &m_fdinfo->m_sockinfo.m_ipv4info.m_fields.m_sip) ||
		   flt_compare(m_cmpop, PT_IPV4ADDR,
			       &m_fdinfo->m_sockinfo.m_ipv4info.m_fields.m_dip))
		{
		    return true;
		}
	    ...
	    {
		throw sinsp_exception("filter error: IP filter only supports "
				      "'=' and '!=' operators");
	    }
	}
	else if(evt_type == SCAP_FD_IPV4_SERVSOCK)
	{
	    ...
	    {
		return flt_compare(m_cmpop, PT_IPV4ADDR,
	...
	else if(evt_type == SCAP_FD_IPV6_SOCK)
	{
		...
		if(flt_compare(
			   m_cmpop, PT_IPV6ADDR,
			   &m_fdinfo->m_sockinfo.m_ipv6info.m_fields.m_sip) ||
		   flt_compare(m_cmpop, PT_IPV6ADDR,
			       &m_fdinfo->m_sockinfo.m_ipv6info.m_fields.m_dip))
		{
		    return true;
		}
	...
	else if(evt_type == SCAP_FD_IPV6_SERVSOCK)
	{
	    if(m_cmpop == CO_EQ || m_cmpop == CO_NE || m_cmpop == CO_IN)
	    {
		return flt_compare(m_cmpop, PT_IPV6ADDR,
...
bool sinsp_filter_check_fd::compare_net(sinsp_evt* evt)
{
	...
	sip_cmp = flt_compare_ipv4net(
		m_cmpop, m_fdinfo->m_sockinfo.m_ipv4info.m_fields.m_sip,
		(ipv4net*)filter_value_p());
	dip_cmp = flt_compare_ipv4net(
		m_cmpop, m_fdinfo->m_sockinfo.m_ipv4info.m_fields.m_dip,
		(ipv4net*)filter_value_p());
	break;

    case SCAP_FD_IPV6_SOCK:
	sip_cmp = flt_compare_ipv6net(
		m_cmpop, &m_fdinfo->m_sockinfo.m_ipv6info.m_fields.m_sip,
		(ipv6net*)filter_value_p());
	dip_cmp = flt_compare_ipv6net(
		m_cmpop, &m_fdinfo->m_sockinfo.m_ipv6info.m_fields.m_dip,
		(ipv6net*)filter_value_p());
	break;
...
bool sinsp_filter_check_fd::compare_port(sinsp_evt* evt)
{
	...
	case CO_IN:
	    if(flt_compare(m_cmpop, PT_PORT, sport, sizeof(*sport)) ||
	       flt_compare(m_cmpop, PT_PORT, dport, sizeof(*dport)))
	    {
		return true;
	    }
	    break;
	default:
	    throw sinsp_exception(
		    "filter error: unsupported port comparison operator");
	}
    }
...
bool sinsp_filter_check_fd::compare_domain(sinsp_evt* evt)
{
	...
	else
	{
		...
		is_local = m_inspector->get_ifaddr_list()
				   ->is_ipv4addr_in_local_machine(
					   m_fdinfo->m_sockinfo.m_ipv4info
						   .m_fields.m_sip,
					   m_tinfo);
	    }
	    else
		...
		is_local = m_inspector->get_ifaddr_list()
				   ->is_ipv6addr_in_local_machine(
					   m_fdinfo->m_sockinfo.m_ipv6info
						   .m_fields.m_sip,
					   m_tinfo);
	    }
		...
		if(m_field_id == TYPE_LIP_NAME)
		{
		    ...
		    {
			addr = &m_fdinfo->m_sockinfo.m_ipv6info.m_fields.m_sip
					.m_b[0];
		    }
		}
		else
		{
		    ...
		    {
			addr = &m_fdinfo->m_sockinfo.m_ipv6info.m_fields.m_dip
					.m_b[0];
		    }
		}
	    }
	...
	else if(m_cmpop == CO_EQ)
	{
	    return sinsp_dns_manager::get().match(
		    ...
		    (evt_type == SCAP_FD_IPV6_SOCK) ? AF_INET6 : AF_INET, addr,
		    ts);
	}
	else if(m_cmpop == CO_NE)
	{
	...
	{
	    throw sinsp_exception("filter error: fd.*ip.name filter only "
...
bool sinsp_filter_check_fd::compare(sinsp_evt* evt)
{
	...
	if(m_field_id == TYPE_CLIENTIP_NAME ||
	   m_field_id == TYPE_SERVERIP_NAME || m_field_id == TYPE_LIP_NAME ||
    ...
    return flt_compare(m_cmpop, m_info.m_fields[m_field_id].m_type,
		       extracted_val, len);
}
...
const filtercheck_field_info sinsp_filter_check_thread_fields[] = {
	{PT_INT64, EPF_NONE, PF_ID, "proc.pid", "Process ID",
	 "the id of the process generating the event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.exe", "First Argument",
	 "the first command line argument (usually the executable name or a "
	 "custom one)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.name", "Name",
	 "the name (excluding the path) of the executable generating the "
	 "event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.args", "Arguments",
	 "the arguments passed on the command line when starting the process "
	 "generating the event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.env", "Environment",
	 "the environment variables of the process generating the event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.cmdline", "Command Line",
	 "full process command line, i.e. proc.name + proc.args."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.exeline", "Executable Command Line",
	 "full process command line, with exe as first argument, i.e. proc.exe "
	 "+ proc.args."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.cwd", "Current Working Directory",
	 "the current working directory of the event."},
	{PT_UINT32, EPF_NONE, PF_DEC, "proc.nthreads", "Threads",
	 "the number of threads that the process generating the event "
	 "currently has, including the main process thread."},
	{PT_UINT32, EPF_NONE, PF_DEC, "proc.nchilds", "Children",
	 "the number of child threads that the process generating the event "
	 "currently has. This excludes the main process thread."},
	{PT_INT64, EPF_NONE, PF_ID, "proc.ppid", "Parent Process ID",
	 "the pid of the parent of the process generating the event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.pname", "Parent Name",
	 "the name (excluding the path) of the parent of the process "
	 "generating the event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.pcmdline", "Parent Command Line",
	 "the full command line (proc.name + proc.args) of the parent of the "
	 "process generating the event."},
	{PT_INT64, EPF_NONE, PF_ID, "proc.apid", "Ancestor Process ID",
	 "the pid of one of the process ancestors. E.g. proc.apid[1] returns "
	 "the parent pid, proc.apid[2] returns the grandparent pid, and so on. "
	 "proc.apid[0] is the pid of the current process. proc.apid without "
	 "arguments can be used in filters only and matches any of the process "
	 "ancestors, e.g. proc.apid=1234."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.aname", "Ancestor Name",
	 "the name (excluding the path) of one of the process ancestors. E.g. "
	 "proc.aname[1] returns the parent name, proc.aname[2] returns the "
	 "grandparent name, and so on. proc.aname[0] is the name of the "
	 "current process. proc.aname without arguments can be used in filters "
	 "only and matches any of the process ancestors, e.g. "
	 "proc.aname=bash."},
	{PT_INT64, EPF_NONE, PF_ID, "proc.loginshellid", "Login Shell ID",
	 "the pid of the oldest shell among the ancestors of the current "
	 "process, if there is one. This field can be used to separate "
	 "different user sessions, and is useful in conjunction with chisels "
	 "like spy_user."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "proc.duration", "Duration",
	 "number of nanoseconds since the process started."},
	{PT_UINT64, EPF_NONE, PF_DEC, "proc.fdopencount", "FD Count",
	 "number of open FDs for the process"},
	{PT_INT64, EPF_NONE, PF_DEC, "proc.fdlimit", "FD Limit",
	 "maximum number of FDs the process can open."},
	{PT_DOUBLE, EPF_NONE, PF_DEC, "proc.fdusage", "FD Usage",
	 "the ratio between open FDs and maximum available FDs for the "
	 "process."},
	{PT_UINT64, EPF_NONE, PF_DEC, "proc.vmsize", "VM Size",
	 "total virtual memory for the process (as kb)."},
	{PT_UINT64, EPF_NONE, PF_DEC, "proc.vmrss", "VM RSS",
	 "resident non-swapped memory for the process (as kb)."},
	{PT_UINT64, EPF_NONE, PF_DEC, "proc.vmswap", "VM Swap",
	 "swapped memory for the process (as kb)."},
	{PT_UINT64, EPF_NONE, PF_DEC, "thread.pfmajor", "Major Page Faults",
	 "number of major page faults since thread start."},
	{PT_UINT64, EPF_NONE, PF_DEC, "thread.pfminor", "Minor Page Faults",
	 "number of minor page faults since thread start."},
	{PT_INT64, EPF_NONE, PF_ID, "thread.tid", "Thread ID",
	 "the id of the thread generating the event."},
	{PT_BOOL, EPF_NONE, PF_NA, "thread.ismain", "Main Thread",
	 "'true' if the thread generating the event is the main one in the "
	 "process."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "thread.exectime",
	 "Scheduled Thread CPU Time",
	 "CPU time spent by the last scheduled thread, in nanoseconds. "
	 "Exported by switch events only."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "thread.totexectime",
	 "Current Thread CPU Time",
	 "Total CPU time, in nanoseconds since the beginning of the capture, "
	 "for the current thread. Exported by switch events only."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "thread.cgroups", "Thread Cgroups",
	 "all the cgroups the thread belongs to, aggregated into a single "
	 "string."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "thread.cgroup", "Thread Cgroup",
	 "the cgroup the thread belongs to, for a specific subsystem. E.g. "
	 "thread.cgroup.cpuacct."},
	{PT_INT64, EPF_NONE, PF_ID, "thread.vtid", "Virtual Thread ID",
	 "the id of the thread generating the event as seen from its current "
	 "PID namespace."},
	{PT_INT64, EPF_NONE, PF_ID, "proc.vpid", "Virtual Process ID",
	 "the id of the process generating the event as seen from its current "
	 "PID namespace."},
	{PT_DOUBLE, EPF_NONE, PF_NA, "thread.cpu", "Thread CPU",
	 "the CPU consumed by the thread in the last second."},
	{PT_DOUBLE, EPF_NONE, PF_NA, "thread.cpu.user", "Thread User CPU",
	 "the user CPU consumed by the thread in the last second."},
	{PT_DOUBLE, EPF_NONE, PF_NA, "thread.cpu.system", "Thread System CPU",
	 "the system CPU consumed by the thread in the last second."},
	{PT_UINT64, EPF_NONE, PF_DEC, "thread.vmsize", "Thread VM Size (kb)",
	 "For the process main thread, this is the total virtual memory for "
	 "the process (as kb). For the other threads, this field is zero."},
	{PT_UINT64, EPF_NONE, PF_DEC, "thread.vmrss", "Thread VM RSS (kb)",
	 "For the process main thread, this is the resident non-swapped memory "
	 "for the process (as kb). For the other threads, this field is zero."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "thread.vmsize.b",
	 "Thread VM Size (b)",
	 "For the process main thread, this is the total virtual memory for "
	 "the process (in bytes). For the other threads, this field is zero."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "thread.vmrss.b",
	 "Thread VM RSS (b)",
	 "For the process main thread, this is the resident non-swapped memory "
	 "for the process (in bytes). For the other threads, this field is "
	 "zero."},
	{PT_INT64, EPF_NONE, PF_ID, "proc.sid", "Process Session ID",
	 "the session id of the process generating the event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.sname", "Process Session Name",
	 "the name of the current process's session leader. This is either the "
	 "process with pid=proc.sid or the eldest ancestor that has the same "
	 "sid as the current process."},
	{PT_INT32, EPF_NONE, PF_ID, "proc.tty", "Process TTY",
	 "The controlling terminal of the process. 0 for processes without a "
	 "terminal."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "proc.exepath", "Process Executable Path",
	 "The full executable path of the process."},
	{PT_CHARBUF, EPF_TABLE_ONLY, PF_NA, "thread.nametid",
	 "Thread Name + ID",
	 "this field chains the process name and tid of a thread and can be "
	 "used as a specific identifier of a thread for a specific execve."},
	{PT_INT64, EPF_NONE, PF_ID, "proc.vpgid", "Process Virtual Group ID",
	 "the process group id of the process generating the event, as seen "
	 "from its current PID namespace."},
	{PT_BOOL, EPF_NONE, PF_NA, "proc.is_container_healthcheck",
	 "Process Is Container Healthcheck",
	 "true if this process is running as a part of the container's health "
	 "check."},
	{PT_BOOL, EPF_NONE, PF_NA, "proc.is_container_liveness_probe",
	 "Process Is Container Liveness",
	 "true if this process is running as a part of the container's "
	 "liveness probe."},
	{PT_BOOL, EPF_NONE, PF_NA, "proc.is_container_readiness_probe",
	 "Process Is Container Readiness",
	 "true if this process is running as a part of the container's "
	 "readiness probe."},
	{PT_BOOL, EPF_NONE, PF_NA, "proc.is_exe_writable",
	 "Process Executable Is Writable",
	 "true if this process' executable file is writable by the same user "
	 "that spawned the process."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "thread.cap_permitted",
	 "Permitted capabilities", "The permitted capabilities set"},
	{PT_CHARBUF, EPF_NONE, PF_NA, "thread.cap_inheritable",
	 "Inheritable capabilities", "The inheritable capabilities set"},
	{PT_CHARBUF, EPF_NONE, PF_NA, "thread.cap_effective",
	 "Effective capabilities", "The effective capabilities set"},
};

sinsp_filter_check_thread::sinsp_filter_check_thread()
{
    m_info.m_name = "process";
    m_info.m_desc = "Additional information about the process and thread "
		    "executing the syscall event.";
    m_info.m_fields = sinsp_filter_check_thread_fields;
    m_info.m_nfields = sizeof(sinsp_filter_check_thread_fields) /
		       sizeof(sinsp_filter_check_thread_fields[0]);
    m_info.m_flags = filter_check_info::FL_WORKS_ON_THREAD_TABLE;
...
int32_t sinsp_filter_check_thread::extract_arg(
	string fldname, string val, OUT const struct ppm_param_info** parinfo)
{
	...
	if(val[fldname.size()] == '[')
	{
	    ...
	    string numstr = val.substr(fldname.size() + 1,
				       parsed_len - fldname.size() - 1);
	...
	if(val[fldname.size()] == '.')
	{
	    ...
	    {
		if(!isalpha(val[endpos]) && val[endpos] != '_')
		{
		    break;
		}
	    }
	    ...
	    m_argname =
		    val.substr(fldname.size() + 1, endpos - fldname.size() - 1);
	}
	else
	{
	    throw sinsp_exception("filter syntax error: " + val);
						    ...
						    bool needed_for_filtering)
{
	...
	//
	throw sinsp_exception(
		"filter error: proc.arg filter not implemented yet");
    }
    ...
    else if(string(val, 0, sizeof("thread.totexectime") - 1) ==
	    "thread.totexectime")
    {
	//
	...
	{
	    m_th_state_id =
		    m_inspector->reserve_thread_memory(sizeof(uint64_t));
	}

	return sinsp_filter_check::parse_field_name(str, alloc_state,
						    needed_for_filtering);
    }
						       ...
						       bool extract_system)
{
	...
	uint64_t* last_t_tot_cpu =
		(uint64_t*)tinfo->get_private_state(m_th_state_id);
	if(*last_t_tot_cpu != 0)
	{
					    ...
					    bool sanitize_strings)
{
    *len = 0;
    ...
    {
	//
	// Relying on the convention that a session id is the process id of the
	// session leader
	//
	...
	else
	{
	    ...
	    // Find the highest ancestor process that has the same session id
	    // and declare it to be the session leader.
	    ...
	    // mt has been updated to the highest process that has the same
	    // session id. mt's comm is considered the session leader.
	    m_tstr = mt->get_comm();
	    RETURN_EXTRACT_STRING(m_tstr);
	}
    }
		...
		case TYPE_PROC_CPU:
			{
				...
				if(etype == PPME_PROCINFO_E)
				{
					...
					sinsp_evt_param* parinfo =
	   evt->get_param(0); tcpu = *(uint64_t*)parinfo->m_val;
					...
					{
						uint64_t deltaval = tcpu -
	   tinfo->m_last_t_tot_cpu; thval = (double)deltaval;// /
	   (ONE_SECOND_IN_NS / 100); if(thval > 100)
						{
							thval = 100;
						}
					}
...
bool sinsp_filter_check_thread::compare_full_apid(sinsp_evt* evt)
{
    ...
    bool found = false;
    sinsp_threadinfo::visitor_func_t visitor =
	    [this, &found](sinsp_threadinfo* pt)
    {
	bool res;

	res = flt_compare(m_cmpop, PT_PID, &pt->m_pid);
...
bool sinsp_filter_check_thread::compare_full_aname(sinsp_evt* evt)
{
	...
	res = flt_compare(m_cmpop, PT_CHARBUF, (void*)pt->m_comm.c_str());
...
const filtercheck_field_info sinsp_filter_check_gen_event_fields[] = {
	{PT_UINT64, EPF_NONE, PF_ID, "evt.num", "Event Number",
	 "event number."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.time", "Time",
	 "event timestamp as a time string that includes the nanosecond part."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.time.s", "Time (s)",
	 "event timestamp as a time string with no nanoseconds."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.time.iso8601", "ISO 8601 Time",
	 "event timestamp in ISO 8601 format, including nanoseconds and time "
	 "zone offset (in UTC)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.datetime", "Datetime",
	 "event timestamp as a time string that includes the date."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.datetime.s", "Datetime (s)",
	 "event timestamp as a datetime string with no nanoseconds."},
	{PT_ABSTIME, EPF_NONE, PF_DEC, "evt.rawtime", "Absolute Time",
	 "absolute event timestamp, i.e. nanoseconds from epoch."},
	{PT_ABSTIME, EPF_NONE, PF_DEC, "evt.rawtime.s", "Absolute Time (s)",
	 "integer part of the event timestamp (e.g. seconds since epoch)."},
	{PT_ABSTIME, EPF_NONE, PF_10_PADDED_DEC, "evt.rawtime.ns",
	 "Absolute Time (ns)",
	 "fractional part of the absolute event timestamp."},
	{PT_RELTIME, EPF_NONE, PF_10_PADDED_DEC, "evt.reltime", "Relative Time",
	 "number of nanoseconds from the beginning of the capture."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "evt.reltime.s", "Relative Time (s)",
	 "number of seconds from the beginning of the capture."},
	{PT_RELTIME, EPF_NONE, PF_10_PADDED_DEC, "evt.reltime.ns",
	 "Relative Time (ns)",
	 "fractional part (in ns) of the time from the beginning of the "
	 "capture."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.pluginname", "Plugin Name",
	 "if the event comes from a plugin, the name of the plugin that "
	 "generated it. The plugin must be currently loaded."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.plugininfo", "Plugin Info",
	 "if the event comes from a plugin, a summary of the event as "
...
sinsp_filter_check_gen_event::sinsp_filter_check_gen_event()
{
    ...
    m_info.m_nfields = sizeof(sinsp_filter_check_gen_event_fields) /
...
Json::Value sinsp_filter_check_gen_event::extract_as_js(sinsp_evt* evt,
							OUT uint32_t* len)
{
    switch(m_field_id)
    {
...
uint8_t* sinsp_filter_check_gen_event::extract(sinsp_evt* evt,
					       OUT uint32_t* len,
					       bool sanitize_strings)
{
    ...
    *len = 0;
	...
	{
	    sinsp_utils::ts_to_string(evt->get_ts(), &m_strstorage, false,
				      true);
	}
...
const filtercheck_field_info sinsp_filter_check_event_fields[] = {
	{PT_RELTIME, EPF_NONE, PF_DEC, "evt.latency", "Latency",
	 "delta between an exit event and the correspondent enter event, in "
	 "nanoseconds."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "evt.latency.s", "Latency (s)",
	 "integer part of the event latency delta."},
	{PT_RELTIME, EPF_NONE, PF_10_PADDED_DEC, "evt.latency.ns",
	 "Latency (ns)", "fractional part of the event latency delta."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.latency.quantized",
	 "Quantized Latency",
	 "10-base log of the delta between an exit event and the correspondent "
	 "enter event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.latency.human",
	 "Human-Readable Latency",
	 "delta between an exit event and the correspondent enter event, as a "
	 "human readable string (e.g. 10.3ms)."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "evt.deltatime", "Delta",
	 "delta between this event and the previous event, in nanoseconds."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "evt.deltatime.s", "Delta (s)",
	 "integer part of the delta between this event and the previous "
	 "event."},
	{PT_RELTIME, EPF_NONE, PF_10_PADDED_DEC, "evt.deltatime.ns",
	 "Delta (ns)",
	 "fractional part of the delta between this event and the previous "
	 "event."},
	{PT_CHARBUF, EPF_PRINT_ONLY, PF_NA, "evt.outputtime", "Output Time",
	 "this depends on -t param, default is %evt.time ('h')."},
	{PT_CHARBUF, EPF_NONE, PF_DIR, "evt.dir", "Direction",
	 "event direction can be either '>' for enter events or '<' for exit "
	 "events."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.type", "Type",
	 "The name of the event (e.g. 'open')."},
	{PT_UINT32, EPF_ARG_REQUIRED, PF_NA, "evt.type.is", "Type Is",
	 "allows one to specify an event type, and returns 1 for events that "
	 "are of that type. For example, evt.type.is.open returns 1 for open "
	 "events, 0 for any other event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "syscall.type", "Syscall Type",
	 "For system call events, the name of the system call (e.g. 'open'). "
	 "Unset for other events (e.g. switch or internal events). Use this "
	 "field instead of evt.type if you need to make sure that the "
	 "filtered/printed value is actually a system call."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.category", "Category",
	 "The event category. Example values are 'file' (for file operations "
	 "like open and close), 'net' (for network operations like socket and "
	 "bind), memory (for things like brk or mmap), and so on."},
	{PT_INT16, EPF_NONE, PF_ID, "evt.cpu", "CPU Number",
	 "number of the CPU where this event happened."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.args", "Arguments",
	 "all the event arguments, aggregated into a single string."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evt.arg", "Argument",
	 "one of the event arguments specified by name or by number. Some "
	 "events (e.g. return codes or FDs) will be converted into a text "
	 "representation when possible. E.g. 'evt.arg.fd' or 'evt.arg[0]'."},
	{PT_DYN, EPF_ARG_REQUIRED, PF_NA, "evt.rawarg", "Raw Argument",
	 "one of the event arguments specified by name. E.g. 'evt.rawarg.fd'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.info", "Information",
	...
	{PT_BYTEBUF, EPF_NONE, PF_NA, "evt.buffer", "Buffer",
	 "the binary data buffer for events that have one, like read(), "
	 "recvfrom(), etc. Use this field in filters with 'contains' to search "
	 "into I/O data buffers."},
	{PT_UINT64, EPF_NONE, PF_DEC, "evt.buflen", "Buffer Length",
	 "the length of the binary data buffer for events that have one, like "
	 "read(), recvfrom(), etc."},
	{PT_CHARBUF, EPF_NONE, PF_DEC, "evt.res", "Return Value",
	 "event return value, as a string. If the event failed, the result is "
	 "an error code string (e.g. 'ENOENT'), otherwise the result is the "
	 "string 'SUCCESS'."},
	{PT_INT64, EPF_NONE, PF_DEC, "evt.rawres", "Raw Return Value",
	 "event return value, as a number (e.g. -2). Useful for range "
	 "comparisons."},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.failed", "Failed",
	 "'true' for events that returned an error status."},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_io", "Is I/O",
	 "'true' for events that read or write to FDs, like read(), send, "
	 "recvfrom(), etc."},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_io_read", "Is Read",
	 "'true' for events that read from FDs, like read(), recv(), "
	 "recvfrom(), etc."},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_io_write", "Is Write",
	 "'true' for events that write to FDs, like write(), send(), etc."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evt.io_dir", "I/O Direction",
	 "'r' for events that read from FDs, like read(); 'w' for events that "
	 "write to FDs, like write()."},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_wait", "Is Wait",
	 "'true' for events that make the thread wait, e.g. sleep(), select(), "
	 "poll()."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "evt.wait_latency", "Wait Latency",
	 "for events that make the thread wait (e.g. sleep(), select(), "
	 "poll()), this is the time spent waiting for the event to return, in "
	 "nanoseconds."},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_syslog", "Is Syslog",
	 "'true' for events that are writes to /dev/log."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evt.count", "Count",
	 "This filter field always returns 1 and can be used to count events "
	 "from inside chisels."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evt.count.error", "Error Count",
	 "This filter field returns 1 for events that returned with an error, "
	 "and can be used to count event failures from inside chisels."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evt.count.error.file",
	 "File Error Count",
	 "This filter field returns 1 for events that returned with an error "
	 "and are related to file I/O, and can be used to count event failures "
	 "from inside chisels."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evt.count.error.net",
	 "Network Error Count",
	 "This filter field returns 1 for events that returned with an error "
	 "and are related to network I/O, and can be used to count event "
	 "failures from inside chisels."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evt.count.error.memory",
	 "Memory Error Count",
	 "This filter field returns 1 for events that returned with an error "
	 "and are related to memory allocation, and can be used to count event "
	 "failures from inside chisels."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evt.count.error.other",
	 "Other Error Count",
	 "This filter field returns 1 for events that returned with an error "
	 "and are related to none of the previous categories, and can be used "
	 "to count event failures from inside chisels."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evt.count.exit", "Exit Count",
	 "This filter field returns 1 for exit events, and can be used to "
	 "count single events from inside chisels."},
	{PT_UINT32, EPF_TABLE_ONLY, PF_DEC, "evt.count.procinfo",
	 "Procinfo Count",
	 "This filter field returns 1 for procinfo events generated by process "
	 "main threads, and can be used to count processes from inside views."},
	{PT_UINT32, EPF_TABLE_ONLY, PF_DEC, "evt.count.threadinfo",
	 "Thread Info Count",
	 "This filter field returns 1 for procinfo events, and can be used to "
	 "count processes from inside views."},
	{PT_UINT64,
	 (filtercheck_field_flags)(EPF_FILTER_ONLY | EPF_ARG_REQUIRED), PF_DEC,
	 "evt.around", "Around Interval",
	 "Accepts the event if it's around the specified time interval. The "
	 "syntax is evt.around[T]=D, where T is the value returned by "
	 "%evt.rawtime for the event and D is a delta in milliseconds. For "
	 "example, evt.around[1404996934793590564]=1000 will return the events "
	 "with timestamp with one second before the timestamp and one second "
	 "after it, for a total of two seconds of capture."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evt.abspath", "Absolute Path",
	 "Absolute path calculated from dirfd and name during syscalls like "
	 "renameat and symlinkat. Use 'evt.abspath.src' or 'evt.abspath.dst' "
	 "for syscalls that support multiple paths."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.buflen.in",
	 "Input Buffer Length",
	 "the length of the binary data buffer, but only for input I/O "
	 "events."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.buflen.out",
	 "Output Buffer Length",
	 "the length of the binary data buffer, but only for output I/O "
	 "events."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.buflen.file",
	 "File Buffer Length",
	 "the length of the binary data buffer, but only for file I/O events."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.buflen.file.in",
	 "File Input Buffer Length",
	 "the length of the binary data buffer, but only for input file I/O "
	 "events."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.buflen.file.out",
	 "File Output Buffer Length",
	 "the length of the binary data buffer, but only for output file I/O "
	 "events."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.buflen.net",
	 "Network Buffer Length",
	 "the length of the binary data buffer, but only for network I/O "
	 "events."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.buflen.net.in",
	 "Network Input Buffer Length",
	 "the length of the binary data buffer, but only for input network I/O "
	 "events."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "evt.buflen.net.out",
	 "Network Output Buffer Length",
	 "the length of the binary data buffer, but only for output network "
	 "I/O events."},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_open_read", "Is Opened For Reading",
	 "'true' for open/openat/openat2/open_by_handle_at events where the "
	 "path was opened for reading"},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_open_write", "Is Opened For Writing",
	 "'true' for open/openat/openat2/open_by_handle_at events where the "
	 "path was opened for writing"},
	{PT_CHARBUF, EPF_TABLE_ONLY, PF_NA, "evt.infra.docker.name",
	 "Docker Name",
	 "for docker infrastructure events, the name of the event."},
	{PT_CHARBUF, EPF_TABLE_ONLY, PF_NA, "evt.infra.docker.container.id",
	 "Docker ID",
	 "for docker infrastructure events, the id of the impacted container."},
	{PT_CHARBUF, EPF_TABLE_ONLY, PF_NA, "evt.infra.docker.container.name",
	 "Container Name",
	 "for docker infrastructure events, the name of the impacted "
	 "container."},
	{PT_CHARBUF, EPF_TABLE_ONLY, PF_NA, "evt.infra.docker.container.image",
	 "Container Image",
	 "for docker infrastructure events, the image name of the impacted "
	 "container."},
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_open_exec",
	 "Is Created With Execute Permissions",
	 "'true' for open/openat/openat2 or creat events where a file is "
...
sinsp_filter_check_event::sinsp_filter_check_event()
{
    ...
    m_info.m_desc =
	    "Event fields applicable to syscall events. Note that for most "
	    "events you can access the individual arguments/parameters of each "
	    "syscall via evt.arg, e.g. evt.arg.filename.";
    m_info.m_fields = sinsp_filter_check_event_fields;
    m_info.m_nfields = sizeof(sinsp_filter_check_event_fields) /
		       sizeof(sinsp_filter_check_event_fields[0]);
    m_u64val = 0;
	...
	throw sinsp_exception(
		...
		"sinsp_filter_check_appevt::sinsp_filter_check_event");
    }
...
int32_t
sinsp_filter_check_event::extract_arg(string fldname, string val,
				      OUT const struct ppm_param_info** parinfo)
{
	...
	{
	    throw sinsp_exception(
		    "evt.arg fields must be expressed explicitly");
	}

	parsed_len = (uint32_t)val.find(']');
	string numstr =
		val.substr(fldname.size() + 1, parsed_len - fldname.size() - 1);
	...
	const struct ppm_param_info* pi =
		sinsp_utils::find_longest_matching_evt_param(
			val.substr(fldname.size() + 1));
...
int32_t sinsp_filter_check_event::extract_type(
	string fldname, string val, OUT const struct ppm_param_info** parinfo)
{
    uint32_t parsed_len = 0;
						   ...
						   bool needed_for_filtering)
{
	...
	res = extract_arg("evt.around", val, NULL);
	    ...
	    string(val, 0, sizeof("evt.latency.quantized") - 1) ==
		    "evt.latency.quantized" ||
	    string(val, 0, sizeof("evt.latency.human") - 1) ==
		    "evt.latency.human")
    {
	//
	// These fields need to store the previous event type in the thread
	// state
	//
	if(alloc_state)
	{
	    m_th_state_id =
		    m_inspector->reserve_thread_memory(sizeof(uint16_t));
	}
	...
	else if(string(val, 0, sizeof("evt.abspath.dst") - 1) ==
		"evt.abspath.dst")
	{
	    m_argid = 2;
						    ...
						    uint32_t storage_len)
{
	...
	parsed_len = sinsp_filter_value_parser::string_to_rawval(
		str, len, filter_value_p(), filter_value()->size(),
		m_arginfo->type);
    }
    else
    {
	parsed_len = sinsp_filter_check::parse_filter_value(str, len, storage,
							    storage_len);
    }
...
void sinsp_filter_check_event::validate_filter_value(const char* str,
						     uint32_t len)
{
    string val(str);
	...
	{
	    throw sinsp_exception(
		    "evt.around supports only '=' comparison operator");
	}
						   ...
						   OUT uint32_t* len)
{
	...
	//
	// We can extract the file path only in case of a successful file
	// opening (fd>0).
	//
	parinfo = evt->get_param(0);
	ASSERT(parinfo->m_len == sizeof(int64_t));
	...
	else if(m_argid == 2)
	{
	    ...
	    etype == PPME_SYSCALL_UNLINKAT_2_X)
    {
	dirfdarg = "dirfd";
	patharg = "name";
    }
    ...
    while(((dirfdargidx < 0) || (pathargidx < 0)) &&
	  (idx < (int)evt->get_num_params()))
    {
	...
	// Some processes (e.g. irqbalance) actually do this: they pass an
	// invalid fd and and absolute path, and openat succeeds.
	//
	sdir = ".";
    }
...
Json::Value sinsp_filter_check_event::extract_as_js(sinsp_evt* evt,
						    OUT uint32_t* len)
{
    switch(m_field_id)
    {
...
uint8_t* sinsp_filter_check_event::extract_error_count(sinsp_evt* evt,
						       OUT uint32_t* len)
{
					   ...
					   bool sanitize_strings)
{
    *len = 0;
	...
	if(evt->m_tinfo != NULL)
	{
	    ...
	    m_converter->set_val(PT_RELTIME, (uint8_t*)&evt->m_tinfo->m_latency,
				 8, 0, ppm_print_format::PF_DEC);
	...
	case 'r':
	    m_strstorage +=
		    to_string((evt->get_ts() - m_inspector->m_firstevent_ts) /
			      ONE_SECOND_IN_NS);
	    m_strstorage += ".";
	    snprintf(timebuffer, sizeof(timebuffer), "%09llu",
		     (evt->get_ts() - m_inspector->m_firstevent_ts) %
			     ONE_SECOND_IN_NS);
	...
	if(etype == PPME_SCHEDSWITCH_6_E || (flags & EC_INTERNAL) ||
	   (flags & EF_SKIPPARSERESET))
	{
	    return NULL;
	}
	...
	{
	    argstr = evt->get_param_value_str(m_argname.c_str(),
					      &resolved_argstr,
					      m_inspector->get_buffer_format());
	}
	...
	{
	    char* il;
	    vector<sinsp_protodecoder*>* cbacks =
		    &(fdinfo->m_callbacks->m_write_callbacks);
	...
	{
	    //
	    // Don't print the arguments for generic events: they have only
	    // internal use
	    //
	    RETURN_EXTRACT_CSTR("");
	}
	...
	const char* resolved_argstr;
	const char* argstr;
	argstr = evt->get_param_value_str("data", &resolved_argstr,
					  m_inspector->get_buffer_format());
	*len = evt->m_rawbuf_str_len;
	...
	if((evt->get_info_flags() & EF_CREATES_FD) &&
	...
	else
	{
		...
		if(pi)
		{
		    ...
		    {
			argstr = evt->get_param_value_str("fd",
							  &resolved_argstr);
			ASSERT(resolved_argstr != NULL &&
			       resolved_argstr[0] != 0);
	...
	else if((evt->get_info_flags() & EF_CREATES_FD) &&
		PPME_IS_EXIT(evt->get_type()))
	{
	    pi = evt->get_param_value_raw("fd");
	...
	if(evt->m_fdinfo && evt->get_category() & EC_IO_BASE)
	{
	    if(evt->m_fdinfo->m_type == SCAP_FD_FILE ||
	       evt->m_fdinfo->m_type == SCAP_FD_FILE_V2)
	    {
		return extract_buflen(evt, len);
	    }
	}
	...
	if(etype == PPME_SYSCALL_OPEN_X || etype == PPME_SYSCALL_OPENAT_E ||
	   ...
	   etype == PPME_SYSCALL_OPEN_BY_HANDLE_AT_X)
	{
	    bool is_new_version = etype == PPME_SYSCALL_OPENAT_2_X ||
				  etype == PPME_SYSCALL_OPENAT2_X;
	    ...
	    if(m_field_id == TYPE_ISOPEN_EXEC &&
	       (flags & (PPM_O_TMPFILE | PPM_O_CREAT) &&
		etype != PPME_SYSCALL_OPEN_BY_HANDLE_AT_X))
	    {
	...
	else if((m_field_id == TYPE_ISOPEN_EXEC) &&
		(etype == PPME_SYSCALL_CREAT_X))
	{
	...
	if(etype == PPME_INFRASTRUCTURE_EVENT_E)
	{
		...
		else if(m_field_id == TYPE_INFRA_DOCKER_CONTAINER_IMAGE)
		{
			...
			{
			    m_strstorage = m_strstorage.substr(
				    0, m_strstorage.find("@"));
			}
...
bool sinsp_filter_check_event::compare(sinsp_evt* evt)
{
	...
	res = flt_compare(m_cmpop, m_arginfo->type, extracted_val);
    }
    else if(m_field_id == TYPE_AROUND)
    {
	uint64_t ts = evt->get_ts();
	...
	bool res1 = ::flt_compare(CO_GE, PT_UINT64, &m_u64val, &t1);

	bool res2 = ::flt_compare(CO_LE, PT_UINT64, &m_u64val, &t2);
...
const filtercheck_field_info sinsp_filter_check_user_fields[] = {
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "user.homedir", "Home Directory",
	 "home directory of the user."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "user.shell", "Shell", "user's shell."},
	{PT_INT32, EPF_NONE, PF_ID, "user.loginuid", "Login User ID",
	 "audit user id (auid)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "user.loginname", "Login User Name",
...
sinsp_filter_check_user::sinsp_filter_check_user()
{
    ...
    m_info.m_nfields = sizeof(sinsp_filter_check_user_fields) /
		       sizeof(sinsp_filter_check_user_fields[0]);
    m_info.m_flags = filter_check_info::FL_WORKS_ON_THREAD_TABLE;
}
...
sinsp_filter_check_group::sinsp_filter_check_group()
{
    ...
    m_info.m_nfields = sizeof(sinsp_filter_check_group_fields) /
		       sizeof(sinsp_filter_check_group_fields[0]);
    m_info.m_flags = filter_check_info::FL_WORKS_ON_THREAD_TABLE;
}
...
const filtercheck_field_info sinsp_filter_check_tracer_fields[] = {
	{PT_INT64, EPF_NONE, PF_ID, "span.id", "Span ID",
	 "ID of the span. This is a unique identifier that is used to match "
	 "the enter and exit tracer events for this span. It can also be used "
	 "to match different spans belonging to a trace."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "span.time", "Time",
	 "time of the span's enter tracer as a human readable string that "
	 "includes the nanosecond part."},
	{PT_UINT32, EPF_NONE, PF_DEC, "span.ntags", "Tag Count",
	 "number of tags that this span has."},
	{PT_UINT32, EPF_NONE, PF_DEC, "span.nargs", "Argument Count",
	 "number of arguments that this span has."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "span.tags", "Tags",
	 "dot-separated list of all of the span's tags."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "span.tag", "Tag",
	 "one of the span's tags, specified by 0-based offset, e.g. "
	 "'span.tag[1]'. You can use a negative offset to pick elements from "
	 "the end of the tag list. For example, 'span.tag[-1]' returns the "
	 "last tag."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "span.args", "Arguments",
	 "comma-separated list of the span's arguments."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "span.arg", "Argument",
	 "one of the span arguments, specified by name or by 0-based offset. "
	 "E.g. 'span.arg.xxx' or 'span.arg[1]'. You can use a negative offset "
	 "to pick elements from the end of the tag list. For example, "
	 "'span.arg[-1]' returns the last argument."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "span.enterargs", "Enter Arguments",
	 "comma-separated list of the span's enter tracer event arguments. For "
	 "enter tracers, this is the same as evt.args. For exit tracers, this "
	 "is the evt.args of the corresponding enter tracer."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "span.enterarg", "Enter Argument",
	 "one of the span's enter arguments, specified by name or by 0-based "
	 "offset. For enter tracer events, this is the same as evt.arg. For "
	 "exit tracer events, this is the evt.arg of the corresponding enter "
	 "event."},
	{PT_RELTIME, EPF_NONE, PF_DEC, "span.duration", "Duration",
	 "delta between this span's exit tracer event and the enter tracer "
	 "event."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "span.duration.quantized",
	 "Quantized Duration",
	 "10-base log of the delta between an exit tracer event and the "
	 "correspondent enter event."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "span.duration.human",
	 "Human-Readable Duration",
	 "delta between this span's exit tracer event and the enter event, as "
	 "a human readable string (e.g. 10.3ms)."},
	{PT_RELTIME,
	 (filtercheck_field_flags)(EPF_TABLE_ONLY | EPF_ARG_REQUIRED), PF_DEC,
	 "span.duration.fortag", "Duration For Tag",
	 "duration of the span if the number of tags matches the field "
	 "argument, otherwise 0. For example, span.duration.fortag[1] returns "
	 "the duration of all the spans with 1 tag, and zero for all the other "
	 "ones."},
	{PT_UINT64, EPF_TABLE_ONLY, PF_DEC, "span.count", "Span Count",
	 "1 for span exit events."},
	{PT_UINT64,
	 (filtercheck_field_flags)(EPF_TABLE_ONLY | EPF_ARG_REQUIRED), PF_DEC,
	 "span.count.fortag", "Count For Tag",
	 "1 if the span's number of tags matches the field argument, and zero "
	 "for all the other ones."},
	{PT_UINT64,
	 (filtercheck_field_flags)(EPF_TABLE_ONLY | EPF_ARG_REQUIRED), PF_DEC,
	 "span.childcount.fortag", "Child Count For Tag",
	 "1 if the span's number of tags is greater than the field argument, "
	 "and zero for all the other ones."},
	{PT_CHARBUF,
	 (filtercheck_field_flags)(EPF_TABLE_ONLY | EPF_ARG_REQUIRED), PF_NA,
	 "span.idtag", "List View ID", "id used by the span list view."},
	{PT_CHARBUF, EPF_TABLE_ONLY, PF_NA, "span.rawtime", "List View Time",
	 "id used by the span list view."},
	{PT_CHARBUF, EPF_TABLE_ONLY, PF_NA, "span.rawparenttime",
	 "List View Parent Time", "id used by the span list view."},
};
...
sinsp_filter_check_tracer::sinsp_filter_check_tracer()
{
    m_storage = NULL;
    m_info.m_name = "span";
    m_info.m_desc = "Fields used if information about distributed tracing is "
		    "available.";
    m_info.m_fields = sinsp_filter_check_tracer_fields;
    m_info.m_nfields = sizeof(sinsp_filter_check_tracer_fields) /
		       sizeof(sinsp_filter_check_tracer_fields[0]);
    m_converter = new sinsp_filter_check_reference();
...
int32_t sinsp_filter_check_tracer::extract_arg(
	string fldname, string val, OUT const struct ppm_param_info** parinfo)
{
    uint32_t parsed_len = 0;
...
int32_t sinsp_filter_check_tracer::parse_field_name(const char* str,
						    bool alloc_state,
						    bool needed_for_filtering)
{
    int32_t res;
    ...
    else if(string(val, 0, sizeof("span.duration.fortag") - 1) ==
    ...
    else if(string(val, 0, sizeof("span.count.fortag") - 1) ==
	    "span.count.fortag")
    {
    ...
    else if(string(val, 0, sizeof("span.childcount.fortag") - 1) ==
    ...
    if(m_field_id == TYPE_DURATION || m_field_id == TYPE_DURATION_QUANTIZED ||
       m_field_id == TYPE_DURATION_HUMAN || m_field_id == TYPE_TAGDURATION ||
       m_field_id == TYPE_ARG || m_field_id == TYPE_ARGS ||
       m_field_id == TYPE_ENTERARG || m_field_id == TYPE_ENTERARGS ||
       m_field_id == TYPE_IDTAG || m_field_id == TYPE_TIME ||
       m_field_id == TYPE_RAWTIME || m_field_id == TYPE_RAWPARENTTIME)
    {
...
uint8_t* sinsp_filter_check_tracer::extract_duration(
	uint16_t etype, sinsp_tracerparser* eparser, OUT uint32_t* len)
{
						 ...
						 OUT uint32_t* len)
{
    ...
    uint32_t encoded_args_len =
	    pae->m_argnames_len + pae->m_argvals_len + nargs + nargs + 2;
	...
	nameit != pae->m_argnames.end(); ++nameit, ++namesit, ++valit, ++valsit)
    {
	strcpy(p, *nameit);
	p += (*namesit);
	*p++ = '=';
					    ...
					    bool sanitize_strings)
{
    *len = 0;
	...
	{
	    m_converter->set_val(PT_RELTIME, (uint8_t*)&m_s64val, 8, 0,
    ...
    case TYPE_TAGCOUNT:
	if(PPME_IS_EXIT(evt->get_type()) &&
	   (int32_t)eparser->m_tags.size() - 1 == m_argid)
	{
	    m_s64val = 1;
	}
	else
	...
	if(PPME_IS_EXIT(evt->get_type()) &&
	   (int32_t)eparser->m_tags.size() > m_argid + 1)
	{
	    m_s64val = 1;
	}
	else
...
const filtercheck_field_info sinsp_filter_check_evtin_fields[] = {
	{PT_INT64, EPF_NONE, PF_ID, "evtin.span.id", "In Span ID",
	 "accepts all the events that are between the enter and exit tracers "
	 "of the spans with the given ID and are generated by the same thread "
	 "that generated the tracers."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evtin.span.ntags", "In Span Tag Count",
	 "accepts all the events that are between the enter and exit tracers "
	 "of the spans with the given number of tags and are generated by the "
	 "same thread that generated the tracers."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evtin.span.nargs",
	 "In Span Argument Count",
	 "accepts all the events that are between the enter and exit tracers "
	 "of the spans with the given number of arguments and are generated by "
	 "the same thread that generated the tracers."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evtin.span.tags", "In Span Tags",
	 "accepts all the events that are between the enter and exit tracers "
	 "of the spans with the given tags and are generated by the same "
	 "thread that generated the tracers."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evtin.span.tag", "In Span Tag",
	 "accepts all the events that are between the enter and exit tracers "
	 "of the spans with the given tag and are generated by the same thread "
	 "that generated the tracers. See the description of span.tag for "
	 "information about the syntax accepted by this field."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evtin.span.args", "In Span Arguments",
	 "accepts all the events that are between the enter and exit tracers "
	 "of the spans with the given arguments and are generated by the same "
	 "thread that generated the tracers."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evtin.span.arg",
	 "In Span Argument",
	 "accepts all the events that are between the enter and exit tracers "
	 "of the spans with the given argument and are generated by the same "
	 "thread that generated the tracers. See the description of span.arg "
	 "for information about the syntax accepted by this field."},
	{PT_INT64, EPF_NONE, PF_ID, "evtin.span.p.id", "In Parent ID",
	 "same as evtin.span.id, but also accepts events generated by other "
	 "threads in the same process that produced the span."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evtin.span.p.ntags",
	 "In Parent Tag Count",
	 "same as evtin.span.ntags, but also accepts events generated by other "
	 "threads in the same process that produced the span."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evtin.span.p.nargs",
	 "In Parent Argument Count",
	 "same as evtin.span.nargs, but also accepts events generated by other "
	 "threads in the same process that produced the span."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evtin.span.p.tags", "In Parent Tags",
	 "same as evtin.span.tags, but also accepts events generated by other "
	 "threads in the same process that produced the span."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evtin.span.p.tag",
	 "In Parent Tag",
	 "same as evtin.span.tag, but also accepts events generated by other "
	 "threads in the same process that produced the span."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evtin.span.p.args",
	 "In Parent Arguments",
	 "same as evtin.span.args, but also accepts events generated by other "
	 "threads in the same process that produced the span."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evtin.span.p.arg",
	 "In Parent Argument",
	 "same as evtin.span.arg, but also accepts events generated by other "
	 "threads in the same process that produced the span."},
	{PT_INT64, EPF_NONE, PF_ID, "evtin.span.s.id", "In Script ID",
	 "same as evtin.span.id, but also accepts events generated by the "
	 "script that produced the span, i.e. by the processes whose parent "
	 "PID is the same as the one of the process generating the span."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evtin.span.s.ntags",
	 "In Script Tag Count",
	 "same as evtin.span.id, but also accepts events generated by the "
	 "script that produced the span, i.e. by the processes whose parent "
	 "PID is the same as the one of the process generating the span."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evtin.span.s.nargs",
	 "In Script Argument Count",
	 "same as evtin.span.id, but also accepts events generated by the "
	 "script that produced the span, i.e. by the processes whose parent "
	 "PID is the same as the one of the process generating the span."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evtin.span.s.tags", "In Script Tags",
	 "same as evtin.span.id, but also accepts events generated by the "
	 "script that produced the span, i.e. by the processes whose parent "
	 "PID is the same as the one of the process generating the span."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evtin.span.s.tag",
	 "In Script Tag",
	 "same as evtin.span.id, but also accepts events generated by the "
	 "script that produced the span, i.e. by the processes whose parent "
	 "PID is the same as the one of the process generating the span."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evtin.span.s.args",
	 "In Script Arguments",
	 "same as evtin.span.id, but also accepts events generated by the "
	 "script that produced the span, i.e. by the processes whose parent "
	 "PID is the same as the one of the process generating the span."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evtin.span.s.arg",
	 "In Script Argument",
	 "same as evtin.span.id, but also accepts events generated by the "
	 "script that produced the span, i.e. by the processes whose parent "
	 "PID is the same as the one of the process generating the span."},
	{PT_INT64, EPF_NONE, PF_ID, "evtin.span.m.id", "In Machine ID",
	 "same as evtin.span.id, but accepts all the events generated on the "
	 "machine during the span, including other threads and other "
	 "processes."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evtin.span.m.ntags",
	 "In Machine Tag Count",
	 "same as evtin.span.id, but accepts all the events generated on the "
	 "machine during the span, including other threads and other "
	 "processes."},
	{PT_UINT32, EPF_NONE, PF_DEC, "evtin.span.m.nargs",
	 "In Machine Argument Count",
	 "same as evtin.span.id, but accepts all the events generated on the "
	 "machine during the span, including other threads and other "
	 "processes."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evtin.span.m.tags", "In Machine Tags",
	 "same as evtin.span.id, but accepts all the events generated on the "
	 "machine during the span, including other threads and other "
	 "processes."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evtin.span.m.tag",
	 "In Machine Tag",
	 "same as evtin.span.id, but accepts all the events generated on the "
	 "machine during the span, including other threads and other "
	 "processes."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "evtin.span.m.args",
	 "In Machine Arguments",
	 "same as evtin.span.id, but accepts all the events generated on the "
	 "machine during the span, including other threads and other "
	 "processes."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "evtin.span.m.arg",
	 "In Machine Argument",
	 "same as evtin.span.id, but accepts all the events generated on the "
	 "machine during the span, including other threads and other "
	 "processes."},
...
sinsp_filter_check_evtin::sinsp_filter_check_evtin()
{
    ...
    m_info.m_nfields = sizeof(sinsp_filter_check_evtin_fields) /
		       sizeof(sinsp_filter_check_evtin_fields[0]);
    m_u64val = 0;
    m_converter = new sinsp_filter_check_reference();
	...
	throw sinsp_exception(
		"memory allocation error in "
		"sinsp_filter_check_appevt::sinsp_filter_check_evtin");
    }
...
int32_t sinsp_filter_check_evtin::parse_field_name(const char* str,
						   bool alloc_state,
						   bool needed_for_filtering)
{
    int32_t res;
    ...
    else if(string(val, 0, sizeof("evtin.span.p.tag") - 1) ==
		    "evtin.span.p.tag" &&
	    string(val, 0, sizeof("evtin.span.p.tags") - 1) !=
		    "evtin.span.p.tags")
    {
    ...
    else if(string(val, 0, sizeof("evtin.span.p.arg") - 1) ==
		    "evtin.span.p.arg" &&
	    string(val, 0, sizeof("evtin.span.p.args") - 1) !=
		    "evtin.span.p.args")
    {
    ...
    else if(string(val, 0, sizeof("evtin.span.s.tag") - 1) ==
		    "evtin.span.s.tag" &&
	    string(val, 0, sizeof("evtin.span.s.tags") - 1) !=
		    "evtin.span.s.tags")
    {
    ...
    else if(string(val, 0, sizeof("evtin.span.s.arg") - 1) ==
		    "evtin.span.s.arg" &&
	    string(val, 0, sizeof("evtin.span.s.args") - 1) !=
		    "evtin.span.s.args")
    {
    ...
    else if(string(val, 0, sizeof("evtin.span.m.tag") - 1) ==
		    "evtin.span.m.tag" &&
	    string(val, 0, sizeof("evtin.span.m.tags") - 1) !=
		    "evtin.span.m.tags")
    {
    ...
    else if(string(val, 0, sizeof("evtin.span.m.arg") - 1) ==
		    "evtin.span.m.arg" &&
	    string(val, 0, sizeof("evtin.span.m.args") - 1) !=
		    "evtin.span.m.args")
    {
...
inline uint8_t* sinsp_filter_check_evtin::extract_tracer(
	sinsp_evt* evt, sinsp_partial_tracer* pae, OUT uint32_t* len)
{
    ASSERT(pae);
    ...
    {
	//
	// If this is a thread-related field, reject anything that doesn't come
    ...
    {
	//
	// If this is a *.p.* field, reject anything that doesn't come from the
	// same process
	//
    ...
    {
	//
	// If this is a *.p.* field, reject anything that doesn't share the same
	// parent
	//
	sinsp_threadinfo* tinfo = m_inspector->get_thread_ref(pae->m_tid).get();
	...
	for(nameit = pae->m_argnames.begin(), valit = pae->m_argvals.begin(),
	namesit = pae->m_argnamelens.begin(),
	valsit = pae->m_argvallens.begin();
...
{
    *len = 0;
    list<sinsp_partial_tracer*>* partial_tracers_list =
	    &m_inspector->m_partial_tracers_list;
    ...
    //
    for(it = partial_tracers_list->begin(); it != partial_tracers_list->end();
	++it)
    {
...
inline bool sinsp_filter_check_evtin::compare_tracer(sinsp_evt* evt,
						     sinsp_partial_tracer* pae)
{
    ...
    if(flt_compare(m_cmpop, m_info.m_fields[m_field_id].m_type, res) == true)
    {
	return true;
    }
    else
...
bool sinsp_filter_check_evtin::compare(sinsp_evt* evt)
{
	...
	{
	    if(etype == PPME_TRACER_E &&
	       *it == tinfo->m_tracer_parser->m_enter_pae)
	    {
		res = false;
		goto fcec_end;
	    }
    ...
    //
    // For PPME_TRACER_X events, it's possible that the pae is already returned
    // to the pool. Get it from the parser.
    //
    if(etype == PPME_TRACER_X)
    {
...
const filtercheck_field_info sinsp_filter_check_syslog_fields[] = {
	{PT_CHARBUF, EPF_NONE, PF_NA, "syslog.facility.str", "Facility",
	 "facility as a string."},
	{PT_UINT32, EPF_NONE, PF_DEC, "syslog.facility", "Numeric Facility",
	 "facility as a number (0-23)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "syslog.severity.str", "Severity",
	 "severity as a string. Can have one of these values: emerg, alert, "
	 "crit, err, warn, notice, info, debug"},
	{PT_UINT32, EPF_NONE, PF_DEC, "syslog.severity", "Numeric Severity",
	 "severity as a number (0-7)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "syslog.message", "Message",
...
sinsp_filter_check_syslog::sinsp_filter_check_syslog()
{
    ...
    m_info.m_nfields = sizeof(sinsp_filter_check_syslog_fields) /
		       sizeof(sinsp_filter_check_syslog_fields[0]);
    m_decoder = NULL;
}
						    ...
						    bool needed_for_filtering)
{
    ...
    if(res != -1)
    {
	m_decoder = (sinsp_decoder_syslog*)m_inspector->require_protodecoder(
		"syslog");
    }
...
const filtercheck_field_info sinsp_filter_check_container_fields[] = {
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.id", "Container ID",
	 "the container id."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.name", "Container Name",
	 "the container name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.image", "Image Name",
	 "the container image name (e.g. falcosecurity/falco:latest for "
	 "docker)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.image.id", "Image ID",
	 "the container image id (e.g. 6f7e2741b66b)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.type", "Type",
	 "the container type, eg: docker or rkt"},
	{PT_BOOL, EPF_NONE, PF_NA, "container.privileged", "Privileged",
	 "true for containers running as privileged, false otherwise"},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.mounts", "Mounts",
	 "A space-separated list of mount information. Each item in the list "
	 "has the format <source>:<dest>:<mode>:<rdrw>:<propagation>"},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "container.mount", "Mount",
	 "Information about a single mount, specified by number (e.g. "
	 "container.mount[0]) or mount source (container.mount[/usr/local]). "
	 "The pathname can be a glob (container.mount[/usr/local/*]), in which "
	 "case the first matching mount will be returned. The information has "
	 "the format <source>:<dest>:<mode>:<rdrw>:<propagation>. If there is "
	 "no mount with the specified index or matching the provided source, "
	 "returns the string \"none\" instead of a NULL value."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "container.mount.source",
	 "Mount Source",
	 "the mount source, specified by number (e.g. "
	 "container.mount.source[0]) or mount destination "
	 "(container.mount.source[/host/lib/modules]). The pathname can be a "
	 "glob."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "container.mount.dest",
	 "Mount Destination",
	 "the mount destination, specified by number (e.g. "
	 "container.mount.dest[0]) or mount source "
	 "(container.mount.dest[/lib/modules]). The pathname can be a glob."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "container.mount.mode",
	 "Mount Mode",
	 "the mount mode, specified by number (e.g. container.mount.mode[0]) "
	 "or mount source (container.mount.mode[/usr/local]). The pathname can "
	 "be a glob."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "container.mount.rdwr",
	 "Mount Read/Write",
	...
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "container.mount.propagation",
	 "Mount Propagation",
	 "the mount propagation value, specified by number (e.g. "
	 "container.mount.propagation[0]) or mount source "
	 "(container.mount.propagation[/usr/local]). The pathname can be a "
	 "glob."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.image.repository",
	 "Repository",
	 "the container image repository (e.g. falcosecurity/falco)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.image.tag", "Image Tag",
	 "the container image tag (e.g. stable, latest)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.image.digest",
	 "Registry Digest",
	 "the container image registry digest (e.g. "
	 "sha256:"
	 "d977378f890d445c15e51795296e4e5062f109ce6da83e0a355fc4ad8699d27)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.healthcheck", "Health Check",
	 "The container's health check. Will be the null value (\"N/A\") if no "
	 "healthcheck configured, \"NONE\" if configured but explicitly not "
	 "created, and the healthcheck command line otherwise"},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.liveness_probe", "Liveness",
	 "The container's liveness probe. Will be the null value (\"N/A\") if "
	 "no liveness probe configured, the liveness probe command line "
	 "otherwise"},
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.readiness_probe", "Readiness",
	 "The container's readiness probe. Will be the null value (\"N/A\") if "
	 "no readiness probe configured, the readiness probe command line "
	 "otherwise"}};
...
sinsp_filter_check_container::sinsp_filter_check_container()
{
    ...
    m_info.m_desc =
	    "Container information. If the event is not happening inside a "
	    "container, both id and name will be set to 'host'.";
    m_info.m_fields = sinsp_filter_check_container_fields;
    m_info.m_nfields = sizeof(sinsp_filter_check_container_fields) /
...
int32_t sinsp_filter_check_container::extract_arg(const string& val,
						  size_t basepos)
{
...
int32_t sinsp_filter_check_container::parse_field_name(
	const char* str, bool alloc_state, bool needed_for_filtering)
{
    string val(str);
    int32_t res = 0;
    ...
    // container.mount. fields allow for indexing by number or source/dest mount
    // path.
    ...
    else if(val.find("container.mount") == 0 && val[basepos - 1] != 's')
    {
...
uint8_t* sinsp_filter_check_container::extract(sinsp_evt* evt,
					       OUT uint32_t* len,
					       bool sanitize_strings)
{
    *len = 0;
	...
	else
	{
		...
		if((m_field_id == TYPE_CONTAINER_HEALTHCHECK &&
		    probe.m_probe_type ==
			    sinsp_container_info::container_health_probe::
				    PT_HEALTHCHECK) ||
...
int32_t sinsp_filter_check_reference::parse_field_name(
	const char* str, bool alloc_state, bool needed_for_filtering)
{
    ASSERT(false);
    return -1;
...
uint8_t* sinsp_filter_check_reference::extract(sinsp_evt* evt,
					       OUT uint32_t* len,
					       bool sanitize_strings)
{
    *len = m_len;
						 ...
						 bool is_int)
{
    ...
    {
	snprintf(m_getpropertystr_storage, sizeof(m_getpropertystr_storage),
		 pr_fmt, str_len - 1,
		 (val) / (1024LL * 1024 * 1024 * 1024 * 1024), 'P');
    }
    else if(val > (1024LL * 1024 * 1024 * 1024))
    {
	snprintf(m_getpropertystr_storage, sizeof(m_getpropertystr_storage),
		 pr_fmt, str_len - 1, (val) / (1024LL * 1024 * 1024 * 1024),
		 'T');
    }
...
char* sinsp_filter_check_reference::format_time(uint64_t val, uint32_t str_len)
{
    ...
    {
	snprintf(m_getpropertystr_storage, sizeof(m_getpropertystr_storage),
		 "%u:%u", (unsigned int)(val / (60 * ONE_SECOND_IN_NS)),
		 (unsigned int)((val / ONE_SECOND_IN_NS) % 60));
    }
    else if(val >= ONE_SECOND_IN_NS)
    {
	snprintf(m_getpropertystr_storage, sizeof(m_getpropertystr_storage),
		 "%u.%02us", (unsigned int)(val / ONE_SECOND_IN_NS),
    ...
    {
	snprintf(m_getpropertystr_storage, sizeof(m_getpropertystr_storage),
		 "%u.%02ums", (unsigned int)(val / (ONE_SECOND_IN_NS / 1000)),
	...
	memmove(m_getpropertystr_storage + padding_size,
		m_getpropertystr_storage, str_len + 1);
...
char* sinsp_filter_check_reference::print_double(uint8_t* rawval,
						 uint32_t str_len)
{
    double val;
						  ...
						  uint64_t time_delta)
{
    ...
    {
	return rawval_to_string(rawval, m_field->m_type,
				m_field->m_print_format, len);
    }
}
						 ...
						 uint64_t time_delta)
{
    ...
    {
	return rawval_to_json(rawval, m_field->m_type, m_field->m_print_format,
			      len);
    }
}
...
const filtercheck_field_info sinsp_filter_check_utils_fields[] = {
	{PT_UINT64, EPF_NONE, PF_ID, "util.cnt", "Counter",
	 "incremental counter."},
};
...
sinsp_filter_check_utils::sinsp_filter_check_utils()
{
    ...
    m_info.m_nfields = sizeof(sinsp_filter_check_utils_fields) /
		       sizeof(sinsp_filter_check_utils_fields[0]);
...
const filtercheck_field_info sinsp_filter_check_fdlist_fields[] = {
	{PT_CHARBUF, EPF_NONE, PF_ID, "fdlist.nums", "FD Numbers",
	 "for poll events, this is a comma-separated list of the FD numbers in "
	 "the 'fds' argument, returned as a string."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fdlist.names", "FD Names",
	 "for poll events, this is a comma-separated list of the FD names in "
	 "the 'fds' argument, returned as a string."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fdlist.cips", "FD Client Addresses",
	 "for poll events, this is a comma-separated list of the client IP "
	 "addresses in the 'fds' argument, returned as a string."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "fdlist.sips", "FD Source Addresses",
	 "for poll events, this is a comma-separated list of the server IP "
	 "addresses in the 'fds' argument, returned as a string."},
	{PT_CHARBUF, EPF_NONE, PF_DEC, "fdlist.cports", "FD Client Ports",
	 "for TCP/UDP FDs, for poll events, this is a comma-separated list of "
	 "the client TCP/UDP ports in the 'fds' argument, returned as a "
	 "string."},
	{PT_CHARBUF, EPF_NONE, PF_DEC, "fdlist.sports", "FD Source Ports",
	 "for poll events, this is a comma-separated list of the server "
	 "TCP/UDP ports in the 'fds' argument, returned as a string."},
};
...
sinsp_filter_check_fdlist::sinsp_filter_check_fdlist()
{
    ...
    m_info.m_nfields = sizeof(sinsp_filter_check_fdlist_fields) /
		       sizeof(sinsp_filter_check_fdlist_fields[0]);
    m_info.m_flags = filter_check_info::FL_WORKS_ON_THREAD_TABLE;
}
...
const filtercheck_field_info sinsp_filter_check_k8s_fields[] = {
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.pod.name", "Pod Name",
	 "Kubernetes pod name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.pod.id", "Pod ID",
	 "Kubernetes pod id."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "k8s.pod.label", "Pod Label",
	 "Kubernetes pod label. E.g. 'k8s.pod.label.foo'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.pod.labels", "Pod Labels",
	 "Kubernetes pod comma-separated key/value labels. E.g. "
	 "'foo1:bar1,foo2:bar2'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.rc.name",
	 "Replication Controller Name",
	 "Kubernetes replication controller name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.rc.id", "Replication Controller ID",
	 "Kubernetes replication controller id."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "k8s.rc.label",
	 "Replication Controller Label",
	 "Kubernetes replication controller label. E.g. 'k8s.rc.label.foo'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.rc.labels",
	 "Replication Controller Labels",
	 "Kubernetes replication controller comma-separated key/value labels. "
	 "E.g. 'foo1:bar1,foo2:bar2'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.svc.name", "Service Name",
	 "Kubernetes service name (can return more than one value, "
	 "concatenated)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.svc.id", "Service ID",
	 "Kubernetes service id (can return more than one value, "
	 "concatenated)."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "k8s.svc.label", "Service Label",
	 "Kubernetes service label. E.g. 'k8s.svc.label.foo' (can return more "
	 "than one value, concatenated)."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.svc.labels", "Service Labels",
	 "Kubernetes service comma-separated key/value labels. E.g. "
	 "'foo1:bar1,foo2:bar2'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.ns.name", "Namespace Name",
	 "Kubernetes namespace name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.ns.id", "Namespace ID",
	 "Kubernetes namespace id."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "k8s.ns.label", "Namespace Label",
	 "Kubernetes namespace label. E.g. 'k8s.ns.label.foo'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.ns.labels", "Namespace Labels",
	 "Kubernetes namespace comma-separated key/value labels. E.g. "
	 "'foo1:bar1,foo2:bar2'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.rs.name", "Replica Set Name",
	 "Kubernetes replica set name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.rs.id", "Replica Set ID",
	 "Kubernetes replica set id."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "k8s.rs.label",
	 "Replica Set Label",
	 "Kubernetes replica set label. E.g. 'k8s.rs.label.foo'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.rs.labels", "Replica Set Labels",
	 "Kubernetes replica set comma-separated key/value labels. E.g. "
	 "'foo1:bar1,foo2:bar2'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.deployment.name", "Deployment Name",
	 "Kubernetes deployment name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.deployment.id", "Deployment ID",
	 "Kubernetes deployment id."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "k8s.deployment.label",
	 "Deployment Label",
	 "Kubernetes deployment label. E.g. 'k8s.rs.label.foo'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "k8s.deployment.labels",
	 "Deployment Labels",
...
{
    m_info.m_name = "k8s";
    m_info.m_desc = "Kubernetes related context. Available when configured to "
		    "fetch k8s meta-data from API Server.";
    m_info.m_fields = sinsp_filter_check_k8s_fields;
    m_info.m_nfields = sizeof(sinsp_filter_check_k8s_fields) /
		       sizeof(sinsp_filter_check_k8s_fields[0]);
    m_info.m_flags = filter_check_info::FL_WORKS_ON_THREAD_TABLE;
}
...
int32_t sinsp_filter_check_k8s::parse_field_name(const char* str,
						 bool alloc_state,
						 bool needed_for_filtering)
{
    string val(str);
    ...
    else if(string(val, 0, sizeof("k8s.deployment.label") - 1) ==
		    "k8s.deployment.label" &&
	    string(val, 0, sizeof("k8s.deployment.labels") - 1) !=
...
int32_t sinsp_filter_check_k8s::extract_arg(const string& fldname,
					    const string& val)
{
	...
	for(endpos = fldname.size() + 1; endpos < val.length(); ++endpos)
	{
	    if(!isalnum(val[endpos]) && val[endpos] != '/' &&
	       val[endpos] != '_' && val[endpos] != '-' && val[endpos] != '.')
	    {
		break;
	    }
	}
...
const k8s_pod_t*
sinsp_filter_check_k8s::find_pod_for_thread(const sinsp_threadinfo* tinfo)
{
    return NULL;
}
...
vector<const k8s_service_t*>
sinsp_filter_check_k8s::find_svc_by_pod(const k8s_pod_t* pod)
{
...
sinsp_filter_check_k8s::find_deployment_by_pod(const k8s_pod_t* pod)
{
    return NULL;
}
...
sinsp_filter_check_k8s::find_svc_by_pod(const k8s_pod_t* pod)
{
    ...
    const k8s_state_t::pod_service_map& pod_services =
	    k8s_state.get_pod_service_map();
...
sinsp_filter_check_k8s::find_deployment_by_pod(const k8s_pod_t* pod)
{
    ...
    const k8s_state_t::pod_deployment_map& pod_deployments =
	    k8s_state.get_pod_deployment_map();
    k8s_state_t::pod_deployment_map::const_iterator it =
	    pod_deployments.find(pod->get_uid());
...
void sinsp_filter_check_k8s::concatenate_labels(const k8s_pair_list& labels,
						string* s)
{
...
void sinsp_filter_check_k8s::concatenate_container_labels(
	const map<std::string, std::string>& labels, string* s)
{
...
bool sinsp_filter_check_k8s::find_label(const k8s_pair_list& labels,
					 ...
					 bool sanitize_strings)
{
    *len = 0;
    ...
    m_tstr.clear();
    // there is metadata we can pull from the container directly instead of the
    // k8s apiserver
    const sinsp_container_info::ptr_t container_info =
	    m_inspector->m_container_manager.get_container(
		    tinfo->m_container_id);
    if(!tinfo->m_container_id.empty() && container_info &&
       !container_info->m_labels.empty())
    {
	switch(m_field_id)
	{
	...
	case TYPE_K8S_NS_NAME:
	    if(container_info->m_labels.count("io.kubernetes.pod.namespace") >
	       0)
	    {
		m_tstr = container_info->m_labels.at(
	...
	case TYPE_K8S_POD_LABELS:
		...
		sandbox_container_id =
			container_info->m_labels.at("io.kubernetes.sandbox.id");
		...
		if(sandbox_container_info &&
		   !sandbox_container_info->m_labels.empty())
		{
		    if(m_field_id == TYPE_K8S_POD_LABEL &&
		       sandbox_container_info->m_labels.count(m_argname) > 0)
		    {
			...
			concatenate_container_labels(
				sandbox_container_info->m_labels, &m_tstr);
			RETURN_EXTRACT_STRING(m_tstr);
		    }
		}
	    }
...
const filtercheck_field_info sinsp_filter_check_mesos_fields[] = {
	{PT_CHARBUF, EPF_NONE, PF_NA, "mesos.task.name", "Task Name",
	 "Mesos task name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "mesos.task.id", "Task ID",
	 "Mesos task id."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "mesos.task.label", "Task Label",
	 "Mesos task label. E.g. 'mesos.task.label.foo'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "mesos.task.labels", "Task Labels",
	 "Mesos task comma-separated key/value labels. E.g. "
	 "'foo1:bar1,foo2:bar2'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "mesos.framework.name", "Framework Name",
	 "Mesos framework name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "mesos.framework.id", "Framework ID",
	 "Mesos framework id."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "marathon.app.name", "App Name",
	 "Marathon app name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "marathon.app.id", "App ID",
	 "Marathon app id."},
	{PT_CHARBUF, EPF_ARG_REQUIRED, PF_NA, "marathon.app.label", "App Label",
	 "Marathon app label. E.g. 'marathon.app.label.foo'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "marathon.app.labels", "App Labels",
	 "Marathon app comma-separated key/value labels. E.g. "
	 "'foo1:bar1,foo2:bar2'."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "marathon.group.name", "Group Name",
	 "Marathon group name."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "marathon.group.id", "Group ID",
	 "Marathon group id."},
};
...
sinsp_filter_check_mesos::sinsp_filter_check_mesos()
{
    ...
    m_info.m_nfields = sizeof(sinsp_filter_check_mesos_fields) /
		       sizeof(sinsp_filter_check_mesos_fields[0]);
    m_info.m_flags = filter_check_info::FL_WORKS_ON_THREAD_TABLE;
}
...
int32_t sinsp_filter_check_mesos::parse_field_name(const char* str,
						   bool alloc_state,
						   bool needed_for_filtering)
{
    string val(str);
    ...
    else if(string(val, 0, sizeof("marathon.app.label") - 1) ==
		    "marathon.app.label" &&
	    string(val, 0, sizeof("marathon.app.labels") - 1) !=
		    "marathon.app.labels")
    {
...
int32_t sinsp_filter_check_mesos::extract_arg(const string& fldname,
					      const string& val)
{
    int32_t parsed_len = 0;
...
mesos_task::ptr_t
sinsp_filter_check_mesos::find_task_for_thread(const sinsp_threadinfo* tinfo)
{
	...
	if(m_inspector && m_inspector->m_mesos_client)
	{
	    ...
	    const mesos_state_t& mesos_state =
		    m_inspector->m_mesos_client->get_state();
...
const mesos_framework*
sinsp_filter_check_mesos::find_framework_by_task(mesos_task::ptr_t task)
{
...
marathon_app::ptr_t
sinsp_filter_check_mesos::find_app_by_task(mesos_task::ptr_t task)
{
    if(m_inspector && m_inspector->m_mesos_client)
    {
...
marathon_group::ptr_t
sinsp_filter_check_mesos::find_group_by_task(mesos_task::ptr_t task)
{
    if(m_inspector && m_inspector->m_mesos_client)
    {
...
void sinsp_filter_check_mesos::concatenate_labels(const mesos_pair_list& labels,
						  string* s)
{
...
bool sinsp_filter_check_mesos::find_label(const mesos_pair_list& labels,
					  const string& key, string* value)
{
    for(const mesos_pair_t& label_pair : labels)
    {
