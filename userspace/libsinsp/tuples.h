...
typedef union _ipv4tuple
{
    ...
    uint8_t m_all[13]; ///< The fields as a raw array ob bytes. Used for
		       ///< hashing.
} ipv4tuple;
...
typedef union _ipv6tuple
{
    ...
    uint8_t m_all[37]; ///< The fields as a raw array ob bytes. Used for
		       ///< hashing.
} ipv6tuple;
...
typedef union _unix_tuple
{
    ...
    uint8_t m_all[16]; ///< The fields as a raw array ob bytes. Used for
		       ///< hashing.
} unix_tuple;
