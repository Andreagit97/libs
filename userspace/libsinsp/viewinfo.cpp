...
///////////////////////////////////////////////////////////////////////////////
sinsp_view_info::sinsp_view_info() { m_valid = false; }

sinsp_view_info::sinsp_view_info(
	viewtype type, string id, string name, string description,
	vector<string> tags, vector<string> tips,
	vector<sinsp_view_column_info> columns, vector<string> applies_to,
	string filter, string drilldown_target, bool use_defaults, bool is_root,
	vector<sinsp_view_action_info> actions, bool drilldown_increase_depth,
	string spectro_type, bool propagate_filter)
{
    m_id = id;
    m_name = name;
...
void sinsp_view_info::set_sorting_col()
{
	...
	throw sinsp_exception(
		"view format error: more than one sorting column");
    }
...
void sinsp_view_info::apply_tag(string tag)
{
    ...
    //
    // Make sure to recalculate the sorting and grouping columns, which could
    // change if we remove columns.
    //
    set_sorting_col();
}

void sinsp_view_info::get_col_names_and_sizes(OUT vector<string>* colnames,
...
void sinsp_view_manager::sort_views()
{
    ...
    //
    sort(m_views.begin(), m_views.end(), cc);
