...
static const filtercheck_field_info sinsp_filter_check_fd_fields[] =
{
	...
	{PT_IPADDR, EPF_FILTER_ONLY | EPF_NO_RHS_FILTER, PF_NA, "fd.ip", "FD IP Address", "matches the ip address (client or server) of the fd."},
	...
	{PT_PORT, EPF_FILTER_ONLY | EPF_NO_RHS_FILTER, PF_DEC, "fd.port", "FD Port", "matches the port (either client or server) of the fd."},
	...
	{PT_PORT, EPF_FILTER_ONLY | EPF_NO_RHS_FILTER, PF_NA, "fd.proto", "FD Protocol", "matches the protocol (either client or server) of the fd."},
	...
	{PT_IPNET, EPF_FILTER_ONLY | EPF_NO_RHS_FILTER, PF_NA, "fd.net", "FD IP Network", "matches the IP network (client or server) of the fd."},
