...
{
    public:
    json_query(const std::string& json = "", const std::string& filter = "",
	       bool dbg = false);
    ~json_query();
    ...
    bool process(const std::string& json, const std::string& filter,
		 bool dbg = false);
...
inline void json_query::set_json(const std::string& json) { m_json = json; }

inline const std::string& json_query::get_json() const { return m_json; }
...
inline const std::string& json_query::get_filter() const { return m_filter; }

inline const std::string& json_query::get_error() const { return m_error; }
