...
class SINSP_PUBLIC sinsp_dumper
{
    ...
    */
    sinsp_dumper(sinsp* inspector, uint8_t* target_memory_buffer,
    ...
    /*!
      ...
      \param threads_from_sinsp If, true the thread and FD tables in the file
       will be created from the current sinsp's tables instead of reusing the
      scap ones.
    ...
    */
    ...
    void fdopen(int fd, bool compress, bool threads_from_sinsp = false);
