...
struct cgroup_limits_key
{
    ...
    cgroup_limits_key(std::string container_id, std::string cpu_cgroup_dir,
...
{
    cgroup_limits_value():
	    m_cpu_shares(0), m_cpu_quota(0), m_cpu_period(0), m_memory_limit(0),
...
{
    std::size_t
    operator()(const libsinsp::cgroup_limits::cgroup_limits_key& h) const
    {
