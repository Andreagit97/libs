...
{
    static void refresh(uint64_t erase_timeout, uint64_t base_refresh_timeout,
			uint64_t max_refresh_timeout, std::future<void> f_exit);
};
...
class sinsp_dns_manager
{
	...
	{
	    return m_v4_addrs == other.m_v4_addrs &&
