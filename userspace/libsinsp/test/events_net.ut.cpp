...
TEST_F(sinsp_with_test_input, net_connect_exit_event_fails) {
	...
	// todo!: this sounds like a bug, the fdinfo shouldn't be updated if the syscall fails and also
	// the filterchecks should not see the updated fdname, keep like this for now.
