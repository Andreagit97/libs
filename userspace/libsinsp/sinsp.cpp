...
void sinsp::open_modern_bpf(unsigned long driver_buffer_bytes_dim, uint16_t cpus_for_each_buffer, const libsinsp::events::set<ppm_sc_code> &ppm_sc_of_interest)
{
