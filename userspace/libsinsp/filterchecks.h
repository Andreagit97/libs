...
public:
	...
	// ogni filter_check ha il suo metodo extract e il suo metodo compare. O almeno quasi tutti 
...
private:
	...
	bool m_is_compare; // cosa fa?  passa da true a false durante la compare
	char* m_storage;
