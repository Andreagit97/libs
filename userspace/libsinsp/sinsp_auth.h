...
class sinsp_ssl
{
    ...
    sinsp_ssl(const std::string& cert, const std::string& key,
...
class sinsp_bearer_token
{
    ...
    sinsp_bearer_token(const std::string& bearer_token_file,
		       bool curl_support = true);
    ~sinsp_bearer_token();
...
inline const std::string& sinsp_ssl::cert_type() const { return m_cert_type; }

inline const std::string& sinsp_ssl::cert() const { return m_cert; }

inline const std::string& sinsp_ssl::key() const { return m_key; }
...
inline const std::string& sinsp_ssl::ca_cert() const { return m_ca_cert; }

inline bool sinsp_ssl::verify_peer() const { return m_verify_peer; }
