...
const filtercheck_field_info sinsp_filter_check_event_fields[] =
{
	...
	{PT_DYN, EPF_ARG_REQUIRED | EPF_NO_RHS_FILTER | EPF_NO_EXTR_MODIFIER, PF_NA, "evt.rawarg", "Raw Argument", "one of the event arguments specified by name. E.g. 'evt.rawarg.fd'."},
